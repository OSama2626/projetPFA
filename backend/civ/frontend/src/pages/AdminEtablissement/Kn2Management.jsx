...
const KN2Management = () => {
  ...
  }, [filterName, filterEmployeeNumber, filterFunction, filterEstablishment, filterCenter]);
  ...
  return (
    <div className="flex w-full h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        <Navbar page={"Gestion des Responsables KN2"}/>
          ...
          {showAddModal && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 w-full max-w-md">
                <h2 className="text-xl font-bold mb-4">Nouveau Responsable KN2</h2>
...
{showEditModal && (
  <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
    <div className="bg-white rounded-lg p-6 w-full max-w-md">
      <h2 className="text-xl font-bold mb-4">Modifier Responsable KN2</h2>
