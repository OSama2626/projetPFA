  ...
  return (
    <div className="flex w-full h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        <Navbar page={"Detaille de PR/DOC du controle à priori "}/>
            ...
            {expandedSections.procedures && (
              <div className="p-6 overflow-x-auto">
                ...
                <div className="mt-4 flex justify-end">
                  <button 
                    onClick={() => navigate('/admin-etablissement/procedure-management')}
                    className="flex items-center text-blue-600 hover:text-blue-800"
                  >
                    <Edit2 size={18} className="mr-1" />
                    Modifier
          ...
          <div className="bg-white rounded-lg shadow mb-6 overflow-hidden">
            ...
            {expandedSections.documents && (
              <div className="p-6 overflow-x-auto">
                ...
                <div className="mt-4 flex justify-end">
                  <button 
                    onClick={() => navigate('/admin-etablissement/document-checklist-management')}
                    className="flex items-center text-blue-600 hover:text-blue-800"
                  >
                    <Edit2 size={18} className="mr-1" />
                    Modifier
...
export default ControleAPrioriDetail;
