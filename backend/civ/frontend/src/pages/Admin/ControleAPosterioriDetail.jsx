...
const ControleAPosterioriDetail = () => {
  const { id } = useParams();
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col">
        <Navbar page={"Detaille de PPOP du controle à posteriori"}/>
<main className="p-6 flex-grow overflow-auto" style={{ overflowY: 'scroll', maxHeight: 'calc(100vh - 64px)' }}>
          ...
          {/* Pratique Professionnels Observables à Postériori (SEF) */}
          <div className="bg-white rounded-lg shadow mb-6 overflow-hidden">
            <div className="border-b">
              <SectionHeader 
                icon={<List size={20} className="text-green-500 ml-6" />}
                title="Pratique Professionnels Observables à Postériori (SEF)" 
                section="ppop" 
              />
            </div>
            
            {expandedSections.ppop && (
              <div className="p-6 overflow-x-auto">
                ...
                <div className="mt-4 flex justify-end">
                  <button 
                    onClick={() => navigate('/ppop-management')}
                    className="flex items-center text-blue-600 hover:text-blue-800"
                  >
                    <Edit2 size={18} className="mr-1" />
                    Modifier
...
export default ControleAPosterioriDetail;
