...
const KN1Management = () => {
  ...
  const [filterAntenna, setFilterAntenna] = useState('');
  ...
  const filteredResponsibles = useMemo(() => {
    return staticKN1Responsibles.filter((resp) => {
      ...
      return (
        ...
        (filterCenter ? resp.center === filterCenter : true) &&
        (filterAntenna ? resp.antenna === filterAntenna : true)
      );
    });
  }, [filterName, filterEmployeeNumber, filterFunction, filterEstablishment, filterCenter, filterAntenna]);
  ...
  return (
    <div className="flex w-full h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        <Navbar page={"Gestion des Responsables KN1"}/>
        <main className="p-6 flex-grow overflow-auto">
          ...
          <div className="mb-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <select
              value={filterAntenna}
              onChange={(e) => setFilterAntenna(e.target.value)}
              className="px-4 py-2 border rounded"
            >
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3">Antenne</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {currentResponsibles.map((responsible) => (
                  <tr key={responsible.id}>
                    ...
                    <td className="px-6 py-4">{responsible.center}</td>
                    <td className="px-6 py-4">{responsible.antenna}</td>
          ...
          {showAddModal && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 w-full max-w-md">
                <h2 className="text-xl font-bold mb-4">Nouveau Responsable KN1</h2>
                <form onSubmit={handleAddSubmit} className="space-y-4">
                  ...
                  <div>
                    <label className="block mb-1">Antenne</label>
                    <select
                      name="antenna"
