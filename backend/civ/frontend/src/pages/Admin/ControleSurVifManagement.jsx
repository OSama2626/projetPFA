...
const ControleSurVifManagement = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col">
        <Navbar page={"Gestion des PR/PPOS/DOC du controle sur le vif"}/>
        <main className="p-6 flex-grow overflow-auto">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold"></h1>
            <button
              onClick={() => navigate('/controle-sur-vif/add')}
                    ...
                    currentData.map((item) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 flex gap-3">
                          <button
                            onClick={() => navigate(`/controle-sur-vif/${item.id}`)}
...
export default ControleSurVifManagement;