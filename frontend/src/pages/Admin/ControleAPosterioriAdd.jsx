...
const ControleAPosterioriAdd = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/controle-a-posteriori');
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col">
        <Navbar page={"Nouveau PPOP du controle à posteriori "}/>
              ...
              {formData.procedures.map((proc, procIndex) => (
                <div key={procIndex} className="mb-6 p-4 border rounded relative bg-white shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block mb-1 font-medium">N° PPOP</label>
                      <input
                        type="number"
                        value={proc.prNumber}
                    ...
                    <div className="md:col-span-2">
                      <label className="block mb-1 font-medium">Désignation PPOP</label>
                      <input
                        type="text"
...
export default ControleAPosterioriAdd;
