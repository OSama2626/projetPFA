...
const Dashboard = () => {
  ...
  const materielData = [
    { name: 'Engins Moteurs', total: 89, operational: 84, maintenance: 5 },
    { name: 'Sites de production', total: 15, operational: 14, maintenance: 1 },
    { name: 'Gares', total: 67, operational: 65, maintenance: 2 },
    { name: 'Lignes', total: 23, operational: 21, maintenance: 2 }
  ];
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        ...
        <main className="p-6 flex-grow overflow-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Structure organisationnelle</h3>
