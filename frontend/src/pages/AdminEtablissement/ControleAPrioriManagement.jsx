...
const ControleAPrioriManagement = () => {
  ...
  return (
    <div className="flex w-full h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        <Navbar page={"Gestion des PR/DOC du controle à priori"}/>
        <main className="p-6 flex-grow overflow-auto">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold"></h1>
            <button
              onClick={() => navigate('/admin-etablissement/controle-a-priori/add')}
                    ...
                    currentData.map((item) => (
                      <tr key={item.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 flex gap-3">
                          <button
                            onClick={() => navigate(`/admin-etablissement/controle-a-priori/${item.id}`)}
...
export default ControleAPrioriManagement;