...
const ProcedureManagement = () => {
  ...
  const handleViewCriteres = (prNumber) => {
    ...
    navigate(`/procedure/${prNumber}/criteres`);
  };
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-grow flex flex-col">
        ...
        <main className="p-6 flex-grow overflow-auto">
          ...
          >
            Ajouter une nouvelle PPOS
          </button>
          <div className="bg-white rounded-lg shadow overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">N° PPOS</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">tYPE PPOS</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Désignation PPOS</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {mockPpos.map((proc) => (
                  <tr key={proc.prNumber} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{proc.type}</td>
